...
<template>
  <section id="hero">
    ...
    <h1 class="tagline">
      <span class="accent">Xt-PMS</span>
      <br /><span style="font-size: 35px;">模具制造及注塑生产管理系统</span>
    </h1>
    <p class="description">
      面向小微制造企业的数字化转型方案
    </p>
    <p class="version-badge">v0.1.0-beta · 测试阶段，谨慎用于生产环境</p>
    <p class="actions">
  ...
  <section id="highlights" class="vt-box-container">
    <div class="vt-box">
      <h2>专为模具注塑打造</h2>
      <p>
        深度贴合模具制造与注塑生产场景，覆盖行业特有工序、模具档案与生产流转模式，不做通用 ERP 的简单套壳。
      </p>
    </div>
    <div class="vt-box">
      <h2>全流程在线管理</h2>
      <p>从订单录单、工序排产、生产报工到产品交付全链路在线，生产数据实时同步，进度透明可追溯。</p>
    </div>
    <div class="vt-box">
      <h2>轻量快捷，开箱即用</h2>
      <p>
        无需专业 IT 团队，简单部署即可上线；界面直观，贴合车间一线操作习惯，让小微型企业快速迈出数字化第一步。
      </p>
    </div>
  </section>
...
.dark .tagline {
  background: -webkit-linear-gradient(135deg, #1E5A8A 0%, #04314D 60%);
